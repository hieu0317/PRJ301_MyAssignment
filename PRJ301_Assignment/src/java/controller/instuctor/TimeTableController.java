...
public class TimeTableController extends BasedRequiredTeacherAuthenticationController {
    ...
    protected void processRequest(HttpServletRequest req, HttpServletResponse resp, User user)
        ...
        Instructor instructor = instrucDB.getTimeTable(u.getInstructor().getiId(), from, to);
        req.setAttribute("in", instructor);

        req.getRequestDispatcher("../view/instructor/weeklyTimetable.jsp").forward(req, resp);
